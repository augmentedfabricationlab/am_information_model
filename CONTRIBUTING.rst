...
1. Fork `the repository <https://github.com/augmentedfabricationlab/am_information_model>`_ and clone the fork.
...
When `reporting a bug <https://github.com/augmentedfabricationlab/am_information_model/issues>`_
please include:
...
`Github <https://github.com/augmentedfabricationlab/am_information_model/issues>`_. If you are proposing a feature:
